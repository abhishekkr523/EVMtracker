...
@Component({
  selector: 'app-evmdialog',
  templateUrl: './evmdialog.component.html',
  styleUrls: ['./evmdialog.component.scss']
})
export class EvmdialogComponent {
  constructor(public dialogRef: MatDialogRef<EvmdialogComponent>) {}
