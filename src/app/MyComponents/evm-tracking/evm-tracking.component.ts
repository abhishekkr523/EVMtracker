...
@Component({
  selector: 'app-evm-tracking',
  templateUrl: './evm-tracking.component.html',
  styleUrls: ['./evm-tracking.component.scss']
})
export class EvmTrackingComponent implements OnInit, OnDestroy{
  private map!: L.Map;
